...
import { MessageEditedSalesmanInfoContainer } from "../styles/style-components";
...
const SuccessfulEditedSalesmanModal = ({ message, handleSubmitOk }) => {
  return (
    <SuccessfulModalContainer>
      <CenterModalContainer>
        <DataModalContainer>
          <Check width={25} height={25} fill={colors.ok} />
          <MessageEditedSalesmanInfoContainer>
            {message}
          </MessageEditedSalesmanInfoContainer>
        </DataModalContainer>
        <Button
...
export default SuccessfulEditedSalesmanModal;
